...
class ActorsCreditsAdapter (private val context: Context, private val castList: List<ActorModel> ):
    RecyclerView.Adapter<ActorsCreditsAdapter.PosterViewHolder>(){

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ActorsCreditsAdapter.PosterViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.poster_credit_layout, parent, false)
        return PosterViewHolder(view)
    }

    override fun onBindViewHolder(holder: ActorsCreditsAdapter.PosterViewHolder, position: Int) {
