...
class OnboardingScreen : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val onboardingItems = listOf(
            OnboardingItem(getString(R.string.first_slide_point_text), getString(R.string.first_slide_desc),
                R.drawable.slide_image_1),
            OnboardingItem(getString(R.string.second_slide_point_text), getString(R.string.second_slide_desc),
                R.drawable.slide_image_2),
            OnboardingItem(getString(R.string.third_slide_point_text), getString(R.string.third_slide_desc),
